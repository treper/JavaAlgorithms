...
public class WordLadderII {
	public ArrayList<ArrayList<String>> findLadders(String start, String end,
			HashSet<String> dict) {
		ArrayList<ArrayList<String>> results = bfs(start, end, dict);
		return results;
	}

	public ArrayList<ArrayList<String>> bfs(String start, String end, HashSet<String> dict)
	{
			...
			while(!cq.isEmpty())
			{
				...
				for (int i = 0; i < start.length(); i++) {
					for (char c = 'a'; c <= 'z'; c++) {
						...
						if(newword.toString().equals(end) || (!visited.contains(newword.toString())
								&& dict.contains(newword.toString()))) {
							visited.add(newword.toString());
							nq.add(newword.toString());
...
//		}
	...
	public ArrayList<ArrayList<String>> bfs2(String start, String end, HashSet<String> dict) {
		ArrayList<ArrayList<String>> results = new ArrayList<ArrayList<String>>();
